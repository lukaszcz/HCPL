...
print_endline (string_of_int (fe 1000000 0 4));
print_endline (string_of_int (fe 1000000 0 2));

print_endline (string_of_int (f 1000000 0 (lazy 4)));
print_endline (string_of_int (f 1000000 0 (lazy 2)));
